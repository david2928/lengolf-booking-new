...
**Status:** To Do
**Priority:** High
**Description:** Create the endpoint to check user's CRM linking status as specified in `TECHNICAL_DESIGN_LENGOLF_VIP.md` (Section 4.1). Requires NextAuth authentication.
