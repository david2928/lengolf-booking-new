    ...
    <footer className="bg-white border-t mt-auto">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:grid md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col">
            ...
            >
              ...
              <div>
                ...
                <span className="block text-xs mt-1 text-gray-500">{tFooter('clickForDirections')}</span>
              </div>
            </a>
          </div>
          ...
          {/* Opening Hours */}
          <div>
            <h5 className="text-[#005a32] font-semibold mb-3">{tFooter('openingHours')}</h5>
            <p className="text-gray-600">
              10am - 11pm<br />
              {tFooter('mondayToSunday')}
            </p>
          </div>

          {/* Keep in Touch */}
          <div>
            <h5 className="text-[#005a32] font-semibold mb-3">{tFooter('keepInTouch')}</h5>
          ...
          {/* Social Media */}
          <div>
            <h5 className="text-[#005a32] font-semibold mb-3">{tFooter('followUs')}</h5>
        ...
        <div className="md:hidden space-y-6">
          ...
          <div className="text-center">
            ...
            >
              ...
              <div className="text-left">
                ...
                <span className="block text-xs mt-1 text-gray-500">{tFooter('tapForDirections')}</span>
              </div>
            </a>
          </div>
          ...
          {/* Opening Hours */}
          <div className="text-center">
            <h5 className="text-[#005a32] font-semibold mb-2">{tFooter('openingHours')}</h5>
            <p className="text-gray-600">
              10am - 11pm<br />
              {tFooter('mondayToSunday')}
            </p>
          ...
          <div className="text-center space-y-2">
            <h5 className="text-[#005a32] font-semibold mb-2">{tFooter('keepInTouch')}</h5>
            <a 
              href="https://www.len.golf" 
