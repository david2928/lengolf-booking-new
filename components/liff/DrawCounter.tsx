...
export default function DrawCounter({ drawsAvailable, onSpinClick, campaignActive = true }: DrawCounterProps) {
  ...
  return (
    <div className="w-full max-w-md mx-auto mb-8 relative group">
      ...
      {hasDraws && (
        <div className="absolute -inset-0.5 bg-gradient-to-r from-green-600 to-amber-400 rounded-2xl blur opacity-30 group-hover:opacity-50 transition duration-1000"></div>
      )}
